...
SECRET_KEY = 'django-insecure-97804r$gahvupz&kxp!2=k0dipk*8w*(#l+7mpdpc3d2dmqoi5'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'resume_generation',  # Replace with your database name
        'USER': 'postgres',  # Replace with your PostgreSQL username
        'PASSWORD': 'santhi@2001',  # Replace with your PostgreSQL password
